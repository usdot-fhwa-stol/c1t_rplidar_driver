...
# laser_geometry ROS package depends on eigen3
# tf2_geometry_msgs ROS package dependds on liborocos-kdl-dev
...
CMD ["roslaunch", "c1t_rplidar_driver", "c1t_rplidar_driver.launch"]
